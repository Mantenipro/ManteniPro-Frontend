  ...
  const uploadImageToS3 = async (file) => {
    ...
    try {
      ...
      if (!presignedUrlResponse.ok) {
        throw new Error(
          `Failed to fetch presigned URL: ${presignedUrlResponse.statusText}`
        )
      }
  ...
  return (
    ...
    >
      ...
      <main className='flex-1'>
        ...
        {/* Profile Image */}
        <div className='mt-5 bg-none text-center'>
          <div className='relative inline-block'>
            ...
            <label
              ...
              className='absolute bottom-0 right-0 cursor-pointer rounded-full bg-gradient-to-r from-[#21262D] to-[#414B66] p-2 text-white hover:bg-blue-600'
            >
              <input
