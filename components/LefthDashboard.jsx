  ...
  return (
    <main className='p-4   text-[#f2f6fc]'>
      <div className='flex justify-center items-center flex-col p-0'>
        ...
        <div className='my-2 ml-8 shadow-sm flex flex-col items-center p-4 bg-gradient-to-b from-[#232c48] to-[#4361b2] rounded-[40px] w-[100px] h-[120px]'>
      ...
      <section className='flex flex-col mt-6 gap-[7rem] md:gap-[15rem]'>
        <div className='Seccion1'>
          ...
          {showProfilesMenu && (
            <div className='ml-6 mt-2 flex flex-col border-l-gray-200 border-l-2 pl-5'>
              <Link href='/tecnicos'>
