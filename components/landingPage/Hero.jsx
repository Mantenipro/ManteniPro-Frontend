  ...
  return (
    <div className="flex flex-col justify-center mx-2">
      <div className="flex flex-col p-4 md:p-10 bg-[url('/bghero.png')] bg-cover h-[30rem]">
        ...
        <p className="text-center text-[16px] lg:text-xl text-azulPersonal mt-4 lg:mt-6 lg:px-[10rem]">
      ...
      <div className="flex flex-wrap justify-center gap-1 mt-[-15rem] md:mt-[-14rem] lg:mt-[-18rem] md:p-6">
        <div className="hidden md:flex justify-end">
          <img className="z-10 md:w-[550px] md:h-[300px] lg:w-[800px] lg:h-[450px]"
            src="/heroimg.svg"
            alt="Hero"
          />
        </div>
        <div className="md:hidden">
          <img className="z-10 w-[350px] h-[600px]"
            src="/mobilehero.png"
            alt="Mobile Hero"
          />
        </div>
